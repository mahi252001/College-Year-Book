...
<html>
	...
	<form action="view teacher table.php" method="post">
		...
		<div class="row">
			...
			<div class="col-sm-6">
						<div class="form-group">
							<select class="form-control" id="sel1" name="branch"  style="border-radius:18px" placeholder="select your branch" required>
