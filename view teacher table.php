<?php
	...
	<!-- Brand -->
		...
		<table align="center" border="5px" style="width:1200px; line-height:40px;">
			<tr>
				<th colspan="11" border="4px"><h2>TEACHERS RECORD</h2></th>
			</tr>
			<t>
			...
			if(isset($_POST['view'])) {
				$year=$_POST['year'];
				$branch=$_POST['branch'];
				$sql="SELECT S.NAME,S.USERNAME,S.MOBILENUMBER,S.GENDER,S.ADDRESS,S.DOB,A.DESIGNATION,A.QUALIFICATION,A.WORK,A.SPECIALIZATION FROM teachers S, teacherachievement A WHERE A.EMAIL=S.USERNAME AND A.YEAR='$year' AND S.BRANCH='$branch'";
